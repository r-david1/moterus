...
- El envío real (email/SMS) se hace vía **puerto** (`ports.OTPSender`) — la implementación concreta (SMTP genérico, proveedor SMS, etc., ver ADR 0054/0055: adaptador directo, sin automatización externa) es un adapter intercambiable.
