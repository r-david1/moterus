...
>
> **Segunda actualización (documentación retroactiva de ADRs de papeleo):** de los siete candidatos restantes, **seis ya tienen ADR propio**, escrito retroactivamente porque el código ya los implementaba de facto sin haberse disputado durante la implementación: `docs/adr/0010-unidad-de-trabajo-transaccion-en-context.md`, `docs/adr/0012-uuidv7-identificador-usuario.md`, `docs/adr/0013-enumeracion-usuarios-login-generico-registro-explicito.md`, `docs/adr/0014-politica-contrasena-nist-hibp-fail-open.md`, `docs/adr/0015-normalizacion-correo-minusculas.md` y `docs/adr/0016-comandos-aplicacion-primitivos.md`. **Tercera actualización: el 0011 también se cerró, con la conclusión de NO implementarlo.** `docs/design/bloqueo-cuenta.md` (ADR 0011) encontró que un lockout automático convierte un ataque de confidencialidad de baja probabilidad en un ataque de disponibilidad garantizado contra cualquier cuenta cuyo correo se conozca, sin que exista hoy ninguna de las tres salidas que lo harían viable (rol de administrador, correo real, o auto-desbloqueo por tiempo — que ya es, funcionalmente, el rate limiting de Confianza que ADR 0018 implementa). `Usuario.Bloquear()` sigue existiendo en el dominio, reservado a una decisión humana futura, custodiado por un test que falla si algún caso de uso lo invoca. El análisis de ese diseño encontró además un bug de seguridad real en el rate limiting ya en producción, corregido en ADR 0052.
>
