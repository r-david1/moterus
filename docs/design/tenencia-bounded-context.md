...
| Invitaciones por correo y su redención | Enviar el correo de la invitación (`NotificadorInvitacionesTransaccional`, directo vía SMTP genérico — ADR 0054/0055) |
...
// Implementación de producción: NotificadorInvitacionesTransaccional (ADR
// 0054/0055, directo vía SMTP genérico); el stub log-only sigue como fallback de desarrollo,
