...
// validada. Tipo propio de confianza/dominio, duplicado a propósito del
// homónimo de identidad/dominio, acceso/dominio y tenencia/dominio (misma
// frontera hexagonal documentada en identificadores.go).
...
// dispositivo e id de solicitud. Tipo propio de confianza/dominio, cuarta
// duplicación deliberada del homónimo de identidad/dominio, acceso/dominio
// y tenencia/dominio, con la misma forma y las mismas reglas (frontera
// hexagonal: confianza/dominio no puede importar el dominio de otro
// contexto). Se llama OrigenSolicitud, y deliberadamente no
