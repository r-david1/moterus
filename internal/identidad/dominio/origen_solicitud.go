...
// longitudMaximaAgenteUsuario acota el User-Agent almacenado (tabla 1.3).
...
// dispositivo e id de solicitud, usado para correlacionar con las trazas
// (INV-ID-16). Se llama OrigenSolicitud, y deliberadamente no
