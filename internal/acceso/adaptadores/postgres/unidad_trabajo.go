...
// técnico internal/plataforma/bd.EjecutarEnTransaccion: abre una
// transacción pgx, la publica en el context.Context para que
// RepositorioSesiones y el ACL de auditoría la usen sin que el puerto
// exponga tipos de pgx, y hace commit/rollback según el resultado de fn.
// Mismo patrón que identidad/adaptadores/postgres.UnidadDeTrabajo.
