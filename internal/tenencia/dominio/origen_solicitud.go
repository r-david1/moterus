...
// validada. Tipo propio de tenencia/dominio, duplicado a propósito del
// homónimo de identidad/dominio y acceso/dominio (§1.7 del diseño;
// INV-TEN-27).
...
// dispositivo e id de solicitud. Tipo propio de tenencia/dominio, duplicado
// a propósito del homónimo de identidad/dominio y acceso/dominio (§1.7 del
// diseño), con la misma forma y las mismas reglas. Se llama OrigenSolicitud,
// y deliberadamente no ContextoSolicitud, para que ningún parámetro se
// confunda con ctx context.Context de Go.
